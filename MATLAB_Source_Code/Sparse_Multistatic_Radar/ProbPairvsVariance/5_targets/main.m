...
%% Searching Vehicle
% Target Init
x_k_vec=[x_vec(2) x_vec(4) x_vec(7) x_vec(10) x_vec(12)];                          %X of target 
y_k_vec=[y_vec(2) y_vec(4) y_vec(7) y_vec(10) y_vec(12)];                        %Y of target 
[R_k_vec,theta_k_vec] = car2pol(x_k_vec,y_k_vec);

V_1k_vec=[Doppler_vec(20) Doppler_vec(40)  Doppler_vec(70) Doppler_vec(100) Doppler_vec(120)];    %Doppler of tg from sensor 1
...
pairing_test=ismember(1,min_comb) & ismember(7,min_comb) & ismember(13,min_comb) & ismember(19,min_comb) & ismember(25,min_comb);
if pairing_test==1
