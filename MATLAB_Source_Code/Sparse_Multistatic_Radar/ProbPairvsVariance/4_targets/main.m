...
%% Searching Vehicle
% Target Init
x_k_vec=[x_vec(3) x_vec(6) x_vec(9) x_vec(12)];                          %X of target 
y_k_vec=[y_vec(3) y_vec(6) y_vec(9) y_vec(12)];                        %Y of target 
[R_k_vec,theta_k_vec] = car2pol(x_k_vec,y_k_vec);

V_1k_vec=[Doppler_vec(20)  Doppler_vec(50) Doppler_vec(80) Doppler_vec(110)];    %Doppler of tg from sensor 1
...
pairing_test=ismember(1,min_comb) & ismember(6,min_comb) & ismember(11,min_comb) & ismember(16,min_comb);
if pairing_test==1
