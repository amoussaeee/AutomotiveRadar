...
function [Estimated_Location, Estimated_Location_Bias,True_Index_Record] = Location_Estimation_Bias(Num_Targets, est_signal, Target_Positions_pol, Target_Positions_car,pol_grid, x_vec, y_vec,I,J)
