...
%% Searching Vehicle
% Target Init
x_k_vec=[x_vec(4) x_vec(9)];                          %X of target 
y_k_vec=[y_vec(4) y_vec(9)];                        %Y of target 
[R_k_vec,theta_k_vec] = car2pol(x_k_vec,y_k_vec);

V_1k_vec=[Doppler_vec(40)  Doppler_vec(80)];    %Doppler of tg from sensor 1
...
pairing_test=ismember(1,min_comb) & ismember(4,min_comb);
if pairing_test==1
...
%save ProbvsNum_test_2000_100_dB.mat
toc