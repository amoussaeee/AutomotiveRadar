...
%% Searching Vehicle
% Target Init
x_k_vec=[x_vec(2) x_vec(4) x_vec(6) x_vec(8) x_vec(10) x_vec(12)];                          %X of target 
y_k_vec=[y_vec(2) y_vec(4) y_vec(6) y_vec(8) y_vec(10) y_vec(12)];                        %Y of target 
[R_k_vec,theta_k_vec] = car2pol(x_k_vec,y_k_vec);

V_1k_vec=[Doppler_vec(20) Doppler_vec(40) Doppler_vec(60) Doppler_vec(80) Doppler_vec(100) Doppler_vec(120)];    %Doppler of tg from sensor 1
...
pairing_test=ismember(1,min_comb) & ismember(8,min_comb) & ismember(15,min_comb) & ismember(22,min_comb) & ismember(29,min_comb) & ismember(36,min_comb);
if pairing_test==1
